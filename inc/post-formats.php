...
<?php if ( has_post_format( 'gallery' ) ): // Gallery ?>
	...
	<div class="post-format">
		<?php $images = dashscroll_post_images(); if ( !empty($images) ): ?>
		<div class="slick-image-slide-wrapper">
			...
			<div class="slick-image-slide" id="slide-<?php the_ID(); ?>">
				<?php foreach ( $images as $image ): ?>
					<div>
						<?php $imageid = wp_get_attachment_image_src($image->ID,'dashscroll-large-h'); ?>
	...
	<div class="post-format">
		<div class="image-container">
			<?php if ( has_post_thumbnail() ) {	
				the_post_thumbnail('dashscroll-large'); 
